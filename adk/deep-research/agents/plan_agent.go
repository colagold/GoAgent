...
import (
	"GoAgent/adk/deep-research/generic"
...
var (
	plannerPromptTemplate = prompt.FromMessages(schema.Jinja2,
		schema.SystemMessage(`You are a professional Deep Researcher. Study and plan information gathering tasks using a team of specialized agents to collect comprehensive data.
...
**6. Information Quantity and Quality Standards**
